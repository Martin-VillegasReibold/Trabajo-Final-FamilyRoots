...
export default function Inspector({
    ...
    return (
        <aside className="w-80 shrink-0 rounded-lg border bg-gradient-to-b from-gray-50 to-gray-100 dark:from-gray-900 dark:to-gray-800 overflow-hidden shadow-sm">
